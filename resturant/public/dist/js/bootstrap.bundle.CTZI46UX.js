(() => {
  ...
  // ../resturant/resturant/public/vendor/bootstrap/js/bootstrap.bundle.js
  var require_bootstrap_bundle = __commonJS({
    "../resturant/resturant/public/vendor/bootstrap/js/bootstrap.bundle.js"(exports, module) {
      (function(global, factory) {
        ...
        class Carousel extends BaseComponent {
          ...
          _getConfig(config) {
            config = __spreadValues(__spreadValues({}, Default$8), config);
          ...
          _orderToDirection(order2) {
            ...
            if (isRTL()) {
              return order2 === ORDER_NEXT ? DIRECTION_LEFT : DIRECTION_RIGHT;
            }
            return order2 === ORDER_NEXT ? DIRECTION_RIGHT : DIRECTION_LEFT;
          }
          static carouselInterface(element, config) {
            let data = Data.get(element, DATA_KEY$9);
            let _config = __spreadValues(__spreadValues({}, Default$8), Manipulator.getDataAttributes(element));
        ...
        class Collapse extends BaseComponent {
          ...
          _getConfig(config) {
            config = __spreadValues(__spreadValues({}, Default$7), config);
          ...
          static collapseInterface(element, config) {
            ...
            const _config = __spreadValues(__spreadValues(__spreadValues({}, Default$7), Manipulator.getDataAttributes(element)), typeof config === "object" && config ? config : {});
        ...
        class Modal extends BaseComponent {
          ...
          hide(event) {
            ...
            if (isAnimated) {
              const transitionDuration = getTransitionDurationFromElement(this._element);
              EventHandler.one(this._element, "transitionend", (event2) => this._hideModal(event2));
              emulateTransitionEnd(this._element, transitionDuration);
            } else {
              this._hideModal();
            }
          ...
          _getConfig(config) {
            config = __spreadValues(__spreadValues({}, Default$5), config);
          ...
          static jQueryInterface(config, relatedTarget) {
            return this.each(function() {
              ...
              const _config = __spreadValues(__spreadValues(__spreadValues({}, Default$5), Manipulator.getDataAttributes(this)), typeof config === "object" && config ? config : {});
              if (!data) {
        ...
        const uriAttrs = /* @__PURE__ */ new Set(["background", "cite", "href", "itemtype", "longdesc", "poster", "src", "xlink:href"]);
        ...
        class Tooltip extends BaseComponent {
          ...
          _getPopperConfig(attachment) {
            ...
            return __spreadValues(__spreadValues({}, defaultBsPopperConfig), typeof this.config.popperConfig === "function" ? this.config.popperConfig(defaultBsPopperConfig) : this.config.popperConfig);
          }
        ...
        class ScrollSpy extends BaseComponent {
          ...
          _getConfig(config) {
            config = __spreadValues(__spreadValues({}, Default$1), typeof config === "object" && config ? config : {});
...
/*!
  ...
  */
//# sourceMappingURL=bootstrap.bundle.CTZI46UX.js.map
